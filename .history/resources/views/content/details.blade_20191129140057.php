            ...
            <div class="col-lg-5 offset-lg-1">
                <div class="s_product_text">
                    ...
                    <div class="card_area d-flex align-items-center">
                        ...
                        <form action="{{ url('wishlists/addToWishlists') }}" method="post">
                            @csrf                            
                            <input type="text hidden" value="{{ $barang_id }}" name="wishlist_barangid">
                            <input type="text hidden" value="{{ session('user_id') }}" name="wishlist_userid">
