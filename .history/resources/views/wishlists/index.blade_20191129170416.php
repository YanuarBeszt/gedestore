                            ...
                            <a href="{{ route('showProduct', $w->barang_id) }}">
                                ...
                                <a href="{{ route('showProduct', $w->barang_id) }}" class="social-info">
                                    ...
                                    <form action="/wishlists/delWishlists/{{ $w->wishlist_id }}" method="post" class="d-inline">
                                        ...
                                        <input type="hidden" value="{{ $w->wishlist_id }}" name="wishlist_barangid">
                                        <!-- <input type="hidden" value="{{ session('user_id') }}" name="wishlist_userid">   -->

                                        <button type="submit" value="submit">hapus</button>

                                         <!-- <a type="submit" value="submit" class="social-info">
                                        ...
                                        <!-- <a class="social-info">
                                        <span class="ti-trash"></span>                                                
                                        <p class="hover-text" value="submit">hapus</p>
                                            <input type="hidden" value="{{ $w->barang_id }}" name="wishlist_barangid">
                                            <input type="hidden" value="{{ session('user_id') }}" name="wishlist_userid">  
