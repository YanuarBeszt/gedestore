                                        ...
                                        <div class="modal-content">
                                          ...
                                          <div class="row">
                                            <div class="input-field col s6 l6">
                                              ...
                                              <input placeholder="Jumlah Pembelian" name="updatedetail" type="number" class="validate" required value="{{ $dtst->detiltrans_masuk_stok }}" autocomplete="off" min="1" max="{{ $dtst->stok_jumlah_stok }}">
